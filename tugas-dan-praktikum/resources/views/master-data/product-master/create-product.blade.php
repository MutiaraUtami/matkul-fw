                        ...
                        <form action="{{ route('product-store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="product_name" name="product_name" value="{{ old('product_name') }}"
                                    class="w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('product_name') border-red-500 @enderror"
                                    required>
                                @error('product_name')
